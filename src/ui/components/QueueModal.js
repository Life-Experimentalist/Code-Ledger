...
export function QueueModal({ onClose, onOpenProblem }) {
  ...
  const handleRemove = async (itemId) => {
    ...
    chrome.runtime.sendMessage({ type: "REMOVE_QUEUE_ITEM", itemId }, () => {
      setRemoving((prev) => {
          ...
          <div class="ml-auto flex items-center gap-2 shrink-0">
            ...
            ${(activeTab === "pending" || activeTab === "all") && counts.pending > 0
              ? html`
                  ...
                  >
                    ${cancellingAll ? "Cancelling…" : "Cancel pending"}
                  </button>
                `
              : ""}
          </div>
                        ...
                        >
                          ...
                          <div class="flex-1 min-w-0">
                            <button
                              onClick=${() => {
                                onClose();
                                onOpenProblem && onOpenProblem(item.problemId);
                              }}
