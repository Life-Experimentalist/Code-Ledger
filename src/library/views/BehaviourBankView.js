        ...
        <div class="flex flex-col gap-4">
            <div class="flex items-center justify-between">
                <p class="text-sm text-slate-400">
                    ${insights.length}
                    insight${insights.length !== 1 ? "s" : ""} stored
                </p>
                <button
            ...
            ${loading
                ...
                : insights.length === 0
                  ? html`<p class="text-xs text-slate-500 py-4">
                        No insights yet. The AI will add insights here as you
            ...
            ${userSkills.length === 0 && !addForm
                ? html`
                      ...
                      >
                          ...
                          <p class="text-xs text-slate-600">
                              Create skills to modify how the AI behaves in
                              specific situations — like a Socratic tutor, a
                              strict time-complexity reviewer, or a
...
export function BehaviourBankView() {
    ...
    return html`
        <div class="flex flex-col gap-6 w-full max-w-3xl mx-auto">
            <!-- Header -->
            <div>
                <h1 class="text-2xl font-light text-white mb-1">
                    Behaviour Bank
                </h1>
                <p class="text-sm text-slate-400">
                    Persistent AI memory — insights, roadmap, and custom skills
                    that shape how the AI assists you.
                </p>
            </div>
