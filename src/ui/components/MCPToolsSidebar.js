          ...
          <div class="space-y-3 text-xs">
            <div class="p-2 bg-white/5 rounded">
              <p class="font-medium text-slate-300">
                Total Problems:
                <span class="text-cyan-300">${res.profile.totalProblems}</span>
              </p>
              <p class="text-slate-400">
                Avg time: ${formatTime(res.profile.averageTimePerProblem)}
              </p>
            </div>
            ...
            html`
              <div class="p-2 bg-white/5 rounded">
                ...
                ${res.profile.topPlatforms.map(
                  (p) => html`
                    <p class="text-slate-400">
                      <span class="font-mono">${p.name}</span>: ${p.count}
                    </p>
                  `,
                )}
              </div>
            ...
            html`
              <div class="p-2 bg-amber-950/20 border border-amber-500/20 rounded">
                ...
                ${res.profile.weakTopics.map(
                  (t) => html`
                    <p class="text-slate-400">
                      <span class="font-mono">${t.name}</span>: ${t.count}
                    </p>
                  `,
                )}
              </div>
              ...
              <div class="p-2 bg-white/5 rounded">
                ...
                ${res.weakTopics
                  ...
                  .map(
                    (t) => html`
                      <p class="text-slate-400">
                        <span class="font-mono">${t.topic}</span>: ${t.count} problems
                      </p>
                    `,
                  )}
              </div>
            ...
            html`
              <div class="p-2 bg-cyan-950/20 border border-cyan-500/30 rounded">
                ...
                <p class="text-slate-400 text-[10px]">
                  ${res.suggested.platform} • ${res.suggested.difficulty}
                </p>
                  ...
                  (p) => html`
                    <div class="p-2 bg-white/5 rounded">
                      ...
                      <p class="text-[10px] text-slate-400">
                        ${p.platform} • ${p.difficulty} (similarity: ${p.similarity})
                      </p>
                    </div>
                  `,
                )}
        ...
        return html`
          <div class="text-xs">
            ...
            <div class="space-y-1 max-h-[200px] overflow-y-auto">
              ...
              html` <p class="text-slate-500 text-[10px] mt-2">... and ${res.count - 5} more</p> `}
            </div>
          </div>
        `;
      ...
      html`
        ...
        >
          <div class="p-4 border-b border-white/5 flex items-center justify-between">
            ...
            <button onClick=${() => setExpanded(false)} class="text-slate-400 hover:text-slate-200">
              ✕
            </button>
          </div>
                    ...
                    return html`
                      ...
                      >
                        <div class="flex items-center justify-between">
                          ...
                          ${executing &&
                          activeTab === id &&
                          html`<span class="text-[10px]">⏳</span>`}
                        </div>
