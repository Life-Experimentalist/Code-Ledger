...
async function run() {
  ...
  await download(
    "https://esm.sh/v135/preact@10.26.0/es2022/preact.mjs",
    "preact.js",
  );
  await download(
    "https://esm.sh/v135/preact@10.26.0/hooks/es2022/hooks.mjs",
    "preact-hooks.js",
  );
  await download("https://esm.sh/v135/htm@3.1.1/es2022/htm.mjs", "htm.js");
  await download(
    "https://esm.sh/v135/chart.js@4.4.1/auto/es2022/auto.mjs",
    "chart.js",
  );
  console.log("Done.");
}
