...
export const Storage = {
    ...
    async saveProblem(problem) {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.onerror = () => {
                dbg.error(
                    `saveProblem(): ✗ failed for ${problemId}`,
                    request.error
                );
    ...
    async getProblem(id) {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.onsuccess = () => {
                ...
                dbg.log(
                    `getProblem(${id}): ${found ? "✓ found" : "NOT found"}`
                );
    ...
    async markSlugLangCommitted(titleSlug, langName) {
        ...
        map[`${titleSlug}::${String(langName || "").toLowerCase()}`] =
            Date.now();
