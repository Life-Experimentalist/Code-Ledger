        ...
        >
            <div>
                ...
                <p class="text-[11px] text-slate-500">
                    Platform labels like "School" and "Basic" are automatically
                    mapped to Easy/Medium/Hard. Add overrides below for any
                    label the built-in rules don't cover.
                </p>
            </div>
            ...
            <div>
                <div
                    class="text-[10px] text-slate-600 uppercase tracking-wider mb-2"
                >
                ...
                <div class="flex flex-wrap gap-1.5">
                    ${builtInEntries.map(
                        ([raw, mapped]) => html`
                            <span
                                key=${raw}
                                class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full border text-[10px] ${DIFF_COLOR[
                                    mapped
                                ] ||
