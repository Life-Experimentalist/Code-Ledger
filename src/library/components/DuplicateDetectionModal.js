    ...
    <div class="border border-white/10 rounded-xl overflow-hidden">
      ...
      <div class="px-4 py-2.5 bg-white/[0.02] flex items-center justify-between gap-4">
        <div class="flex items-center gap-2 min-w-0">
          ...
          <span
            class="shrink-0 px-1.5 py-0.5 rounded text-[10px] bg-emerald-500/15 text-emerald-400 border border-emerald-500/20"
          >
            same code
          </span>
        </div>
    ...
    <div class="border border-white/10 rounded-xl overflow-hidden">
      ...
      <div class="px-4 py-2.5 bg-white/[0.02] flex items-center justify-between gap-4">
        <div class="flex items-center gap-2 min-w-0">
          ...
          <span
            class="shrink-0 px-1.5 py-0.5 rounded text-[10px] bg-amber-500/15 text-amber-400 border border-amber-500/20"
          >
            different approach
          </span>
        </div>
...
export function DuplicateDetectionModal({
  ...
  return html`
    ...
    >
      <div
        class="w-full max-w-4xl max-h-[90vh] flex flex-col bg-[#0a0a0f] border border-rose-500/20 rounded-2xl shadow-2xl overflow-hidden"
      >
        <!-- Header -->
        <div
          class="px-6 py-5 border-b border-white/5 flex items-center justify-between shrink-0 gap-4"
        >
            ...
            <div class="flex items-center gap-3 flex-wrap">
              ...
              ${diffApproachCount > 0 || sameCodeCount > 0
                ? html`<div class="flex items-center gap-2 text-[11px]">
                    ${diffApproachCount > 0
                      ? html`<span
                          class="px-2 py-0.5 rounded bg-amber-500/15 text-amber-400 border border-amber-500/20"
                        >
                    ...
                    ${sameCodeCount > 0
                      ? html`<span
                          class="px-2 py-0.5 rounded bg-emerald-500/15 text-emerald-400 border border-emerald-500/20"
                        >
