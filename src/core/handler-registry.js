        ...
        schemas.push({
            ...
            fields: [
                ...
                },
                {
                    ...
                    default: true,
                    description:
                        "Automatically analyze code with AI upon completion.",
                },
                {
                    key: "notifications",
                ...
                // ── AI routing consumed by AI tab; filtered out of General view ──
                {
                    ...
                    description:
                        "Preferred AI provider to use for automated reviews.",
                ...
                },
                {
                    ...
                    default: "",
                    description:
                        "Fallback provider to be used if the primary fails. Same provider is allowed when the fallback model differs.",
                    options: Object.keys(CONSTANTS.AI_PROVIDERS).map((id) => ({
                        value: id,
                        label: CONSTANTS.AI_PROVIDERS[id].name,
                    })),
                ...
                },
                {
                    ...
                    advanced: true,
                    placeholder:
                        "[{topic}] {title} — {difficulty} | {language}",
                    description:
