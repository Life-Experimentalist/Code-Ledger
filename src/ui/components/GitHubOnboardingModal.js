...
export function GitHubOnboardingModal({ isOpen, onComplete, username, token }) {
    ...
    const linkExistingRepo = async () => {
        ...
        try {
            ...
            const contents = await ghFetch(
                `/repos/${username}/${repoToLink}/contents`
            ).catch(() => []);
            if (
    ...
    return html`
        ...
        <div
            ...
            onClick=${(e) =>
                e.target === e.currentTarget && canClose && onComplete()}
        >
            <div
                class="bg-[#0a0a0f] border border-cyan-500/20 rounded-2xl w-full max-w-lg shadow-2xl"
            >
                <!-- Header -->
                <div
                    class="px-8 py-6 border-b border-white/5 flex items-center justify-between"
                >
                    <div>
                              ...
                              <div class="space-y-4">
                                  <p class="text-sm text-slate-400 mb-6">
                                      ...
                                      <span class="text-emerald-400 font-medium"
                                          >${username}</span
                                      >! Choose how to set up your CodeLedger
                                      repository.
                                  </p>
                                  ...
                                  >
                                      ...
                                      >
                                          <div>
                                              ...
                                              >
                                                  Fresh repo with CodeLedger
                                                  structure and GitHub Pages
                                              </p>
                                          </div>
                                          <span
                                      ...
                                      >
                                          <div>
                                              ...
                                              <p
                                                  class="text-xs text-slate-400 mt-1"
                                              >
                                                  Connect an existing GitHub
                                                  repo (empty or existing
                                                  CodeLedger repo)
                                              </p>
                                          </div>
                                          <span
                        ...
                        ? html`
                              <div class="space-y-4">
                                  <p class="text-xs text-slate-400">
                                      Select a repository to connect. It must be
                                      empty or already contain CodeLedger's
                        ...
                        ? html`
                              <div class="space-y-4 text-center">
                                  ...
                                  <div>
                                      ...
                                      <p class="text-sm text-slate-400 mt-2">
                                          Every accepted solution will be
                                  ...
                                  >
                                      ...
                                      <p
                                          class="text-sm font-mono text-cyan-300"
                                      >
                                          ${username}/${finalRepo}
                                      </p>
                                      <a
...
async function initializeRepository(owner, repo, token) {
    ...
    for (let attempt = 0; attempt < 6; attempt++) {
        try {
            ...
            if (attempt === 5)
                throw new Error(
                    "Repository branch not ready. Please try again."
                );
    ...
    const treeRes = await ghFetch(`/repos/${owner}/${repo}/git/trees`, {
        ...
        body: JSON.stringify({
            ...
            tree: [
                ...
                {
                    path: ".github/workflows/sync-stats.yml",
                    mode: "100644",
                    type: "blob",
...
const WORKFLOW_YAML = `name: Sync Stats
on:
  push:
