...
import { checkSubmission, processSubmission, onSubmitFired, isAcceptedVisible } from "./submission-detector.js";
import { syncButtonsForCurrentPage, injectDetailSyncBtn, injectSubmissionListSyncBtn, injectProfileActionButtons, removeProfileActionButtons, manualSync } from "./ui-injection.js";
...
Be concise. Max 200 words.`;
    ...
    _syncButtonsForCurrentPage() { return syncButtonsForCurrentPage(this); }

    _injectDetailSyncBtn(page) { return injectDetailSyncBtn(this, page); }
    _injectSubmissionListSyncBtn(page) { return injectSubmissionListSyncBtn(this, page); }
    async _manualSync(page, btn) { return manualSync(this, page, btn); }

    /* ── Progress page import (delegates to profile-import.js) ──────── */
    async _injectProgressImportBtn() { return injectProgressImportBtn(this); }
    _removeProgressImportButton() { return removeProgressImportButton(); }

    async _injectProfileActionButtons() { return injectProfileActionButtons(this); }
    _removeProfileActionButtons() { return removeProfileActionButtons(); }
    ...
    _onSubmitFired() { return onSubmitFired(this); }
    ...
    async _checkSubmission() { return checkSubmission(this); }
     ...
     */
    _isAcceptedVisible() { return isAcceptedVisible(this); }
    async _processSubmission(page, isManual) { return processSubmission(this, page, isManual); }
