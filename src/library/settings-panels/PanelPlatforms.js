        ...
        <div class="space-y-6 w-full">
            <div>
                ...
                <p class="text-xs text-slate-500 mb-4">
                    Enable tracking per platform, customize difficulty labels,
                    and trigger profile imports.
                </p>
            </div>
                        ...
                        html`
                            ...
                            <div>
                                <p class="text-[11px] text-slate-500 mb-2">
                                    Difficulty label aliases (leave blank to use
                                    default)
                                </p>
                            ...
                            <div class="space-y-2">
                                <p class="text-[11px] text-slate-500">
                                    Open pages to trigger in-page import
                                    buttons:
                                </p>
                                ...
                                html`
                                    <p
                                        class="text-[10px] text-slate-600 leading-snug"
                                    >
                                        Profile import syncs your public solve
                                        count. Progress page imports full
                                        submission history (first-time only for
                                        each problem+language).
                                    </p>
                                `}
                                ${importMsg[p.id] &&
                                html`
                            ...
                            html`
                                <div
                                    class="pt-1 border-t border-white/5 space-y-3"
                                >
                                    <p
