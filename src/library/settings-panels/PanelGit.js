    ...
    return html`
        <div class="space-y-6 max-w-xl">
            ...
            >
                ...
                <div>
                    ...
                    <input
                        ...
                        onInput=${(e) =>
                            onSettingsChange("github_repo", e.target.value)}
                ...
                <div>
                    ...
                    <input
                        ...
                        onInput=${(e) =>
                            onSettingsChange("github_owner", e.target.value)}
                        class="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-1.5 text-sm text-slate-300 placeholder-slate-600 focus:outline-none focus:border-cyan-500/40"
                    />
                </div>
                ${repoUrl &&
            ...
            >
                ...
                <p class="text-[11px] text-slate-500">
                    Force-push all local problems to your repository and rebuild
                    the <code class="text-slate-400">index.json</code> manifest.
                    ${syncCount !== null && syncCount > 0
                        ? html`
                              <span class="text-amber-400">
                                  ${syncCount}
                                  problem${syncCount !== 1 ? "s" : ""} pending
                                  commit.</span
                              >
                          `
                        : ""}
                ...
                <div class="flex gap-2">
                    <button
                        ...
                        !gitEnabled ||
                        activeProvider?.status !==
                            CONSTANTS.FEATURE_STATUS.STABLE}
                ...
                activeProvider.status !== CONSTANTS.FEATURE_STATUS.STABLE
                    ? html`
                          <p class="text-[11px] text-amber-400">
                              ${STATUS_META[activeProvider.status]?.label ||
                              "This provider"}
                              is not ready yet.
                          </p>
                      `
