    ...
    <div class="flex flex-col gap-8 w-full">
        ...
        ${formOpen
          ? html`
              ...
              >
                    ...
                    (alias, i) => html`
                      <div class="flex gap-2 items-center">
                        ...
                        <div class="flex items-center gap-1.5 flex-1">
                          ${PLATFORM_FAVICON[alias.platform]
                            ? html`
                                <img
                                  src=${PLATFORM_FAVICON[alias.platform]}
                                  alt=""
                ...
                >
                  ${submitting ? "Submitting…" : "Submit GitHub Issue"}
                </button>
              </div>
            `
          : ""}
        ...
        ${!issuesLoading && !issuesError && issues.length === 0
          ? html`
              <p class="text-[11px] text-slate-600 italic">
                No pending canonical requests. Be the first to submit one!
              </p>
            `
          : ""}
        ${issues.map((issue) => {
      ...
      >
              ...
              >
                ...
                <div class="flex gap-2 pt-1">
                  <button
                    ...
                    class="flex-1 px-3 py-2 rounded-lg text-xs font-semibold transition-colors ${localSaving ||
                    !localTitle.trim()
        ...
        ${localEntries.length === 0 && !localFormOpen
          ? html`<p class="text-[11px] text-slate-600 italic">
              No local entries yet. Add one above.
            </p>`
          : ""}
        ${localEntries.map(
          (entry) => html`
