...
export function HeatMap({ problems = [] }) {
    ...
    const { grid, currentStreak, maxStreak, maxCount } = useMemo(() => {
        ...
        const addToDay = (ds, rawLabel, category) => {
            if (!dayMap[ds])
                dayMap[ds] = { easy: 0, medium: 0, hard: 0, raw: {} };
        ...
        >
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-2">
                    <span class="text-[10px] text-slate-600"
                        >Current:
                        <b class="text-cyan-400">${currentStreak}d</b></span
                    >
                    <span class="text-[10px] text-slate-600"
                        >Best: <b class="text-cyan-400">${maxStreak}d</b></span
                    >
                    <select
            ...
            >
                ...
                <div class="flex" style="gap: 0;">
                    ...
                    <div
                        class="flex"
                        style="gap: 2px; flex: 1; overflow: hidden;"
                    >
                        ${grid.map(
                            (week, wi) => html`
                                <div
            ...
            ${active
                ? html`
                      <div
                          ...
                          class="p-3 w-60 bg-[#071018] border ${pinned
                              ? "border-cyan-500/30"
                              : "border-white/10"} rounded-xl text-sm text-slate-200 shadow-2xl"
                          onClick=${(e) => e.stopPropagation()}
                      >
                          <div class="flex items-center justify-between mb-2">
                              ...
                              ${pinned
                                  ? html`<button
                                        onClick=${() => setPinned(null)}
                                        class="text-slate-500 hover:text-slate-300 text-[10px] px-1"
                                    >
                                        ✕
                                    </button>`
                          ...
                          <div class="flex gap-3 mb-2">
                              ...
                              <div class="text-center">
                                  <div
                                      class="text-[11px] text-rose-400 font-medium"
                                  >
                                      Hard
                                  </div>
                                  <div class="text-xs text-slate-300">
                          ...
                          ${active.day.total === 0
                              ? html`<div class="text-[11px] text-slate-600">
                                    No solves
                                </div>`
                              : ""}
                      </div>
