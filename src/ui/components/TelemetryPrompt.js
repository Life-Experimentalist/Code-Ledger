...
export function TelemetryPrompt({ onComplete }) {
    return html`
        ...
        >
            <div
                class="bg-[#11111a] border border-white/10 rounded-2xl max-w-md w-full p-6 shadow-2xl flex flex-col gap-4 relative overflow-hidden"
            >
                <div
                ...
                <p class="text-sm text-slate-300 z-10 leading-relaxed">
                    ...
                    CFlair-Counter. This helps us understand which platforms and
                    features are used most.
                </p>

                <div
                    class="bg-black/30 rounded-lg p-3 border border-white/5 z-10"
                >
                    <p
                    ...
                    <p class="text-xs text-slate-500 mb-2 pl-5">
                        Platform solve counts, extension version, and generic
                        errors.
                    </p>
                    ...
                    <p
                        class="text-xs text-slate-400 font-mono flex items-center gap-2 mb-1"
                    >
                        <span class="text-rose-400 opacity-80">✗</span> What we
                        NEVER collect:
                    </p>
                    <p class="text-xs text-slate-500 pl-5">
                        Your code, AI API keys, GitHub tokens, problem titles,
