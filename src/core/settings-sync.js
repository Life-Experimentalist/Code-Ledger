...
const PORTABLE_PREFIXES = ["leetcode_", "geeksforgeeks_", "codeforces_", "claude_", "openai_", "gemini_", "deepseek_", "ollama_", "openrouter_"];
...
export async function syncSettingsFromGitHub() {
    try {
        ...
        return {
            synced: syncedCount,
            message: syncedCount > 0 ? `Applied ${syncedCount} setting(s) from repo` : "Already up-to-date",
        };
    } catch (e) {
