...
export function injectQoL(container, selectors) {
  ...
  const editorHeaderActions = container.querySelector('div.flex.h-8.items-center.justify-between > div.flex.h-full.items-center.gap-1') 
                            || document.querySelector('div.flex.h-8.items-center.justify-between > div.flex.h-full.items-center.gap-1')
                            || container;
