...
function H() {
  try {
    for (var n3, l3 = 1; i.length; )
      (i.length > l3 && i.sort(e), (n3 = i.shift()), (l3 = i.length), I(n3));
  } finally {
    i.length = H.__r = 0;
  }
}
function L(n3, l3, u3, t4, i3, r3, o3, e3, f3, c3, s3) {
  ...
  for (f3 = T(u3, l3, m3, f3, b3), a3 = 0; a3 < b3; a3++)
    null != (p3 = u3.__k[a3]) &&
      ...
      p3.ref &&
        h3.ref != p3.ref &&
        (h3.ref && J(h3.ref, null, p3), s3.push(p3.ref, p3.__c || v3, p3)),
...
function K(n3, u3, t4) {
  ...
  if (
    ...
    (i3 = n3.ref) && ((i3.current && i3.current != n3.__e) || J(i3, null, u3)),
    null != (i3 = n3.__c))
  ) {
...
function x2(n3) {
  ...
  return (
    (i3.c = n3),
    u3 ? (null == i3.__ && ((i3.__ = true), u3.sub(r2)), u3.props.value) : n3.__
  );
}
function P2(n3, t4) {
